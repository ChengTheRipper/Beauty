...
public class QRCodeTool {
    ...
    /// <returns></returns>
    public Texture2D NormalEncodeQRCode(string code, Vector2 size)
    {
        ...
        BitMatrix _bitMatrix = new MultiFormatWriter().encode(code, BarcodeFormat.QR_CODE, (int)(size.x), (int)size.y, hints);
